...
output_shp_file = r'../geodata/UTM_Zone_Boundaries_%i.shp' % EPSG
...
output_shp_layer = output_shp_dataset.CreateLayer("basemap_%i" % EPSG, geom_type=ogr.wkbMultiPolygon)
